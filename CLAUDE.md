...
| Franchise history, owner attribution, `ownerHistory` | `docs/claude/insights/features/franchise-history.md` + `docs/plans/owners-feature.md` | Owner-scoping DELETES history rather than relocating it — a third of all franchise-seasons, and 14 championships, belong to no page. Five copies of the ownership-boundary rule exist and two already disagree. |
