...
- [ ] **F1 — Resolve the third-place bracket by name, not by id**
...
- [ ] **F2 — Recover third place for the seasons whose export has no ids**
...
- [ ] **F3 — Guard test: a resolved third place is never the champion or runner-up**
