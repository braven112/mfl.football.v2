...
// Correct 2021 salaries from Google Doc
...
const playersFile = 'data/theleague/mfl-feeds/2021/players.json';
const rostersFile = 'data/theleague/mfl-feeds/2021/rosters.json';
