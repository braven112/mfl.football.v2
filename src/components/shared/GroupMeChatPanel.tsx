/**
 * GroupMeChatPanel — Compose bar for sending messages to GroupMe via the bot.
 *
 * All franchise-to-GroupMe mappings are done by the admin via the API.
 * This component is just the compose UI for authenticated owners.
 *
