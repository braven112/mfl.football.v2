  ...
  return (
    <section className="ri-section">
      ...
      <p className="ri-section__desc">
        ...
        <span className="ri-section__note">Desktop only — bookmarklets require a browser with a bookmarks bar. On mobile the built-in sources above already give you a full board with nothing to install.</span>
      </p>
