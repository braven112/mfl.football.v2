 ...
 * Championship, the legacy AFL Cup (2016–2017 only, before the
 * conference-championship BRACKETS began in 2018 — the AL/NL conferences
 * themselves have existed since 2003; see afl-structure.ts), the two
 * conference (AL/NL) titles, division titles (four today, six in the 2003-2012
 * layout incl. AL Central and NL Pacific), the NIT consolation crown, and the
 * two all-play tier championships (Premier League / D-League). Each has its
 * own branded SVG badge under public/assets/afl/awards/. Not every award
 * exists in every era — a season carries only the awards it actually held.
 *
