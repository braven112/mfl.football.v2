...
// Reads use api.myfantasyleague.com; commissioner writes fail on the api
// subdomain — see defaultMflWriteHost.
...
const BACKUP_DIR = join(process.cwd(), LEAGUES[DEFAULT_LEAGUE_SLUG].dataPath, 'contract-backups');
