...
- For complex tasks, read `CLAUDE.md` first. It is a router: it carries the repo-wide rules and a "Read before you touch" table pointing at `docs/claude/rules/<domain>.md`, which holds the detail for each area.
